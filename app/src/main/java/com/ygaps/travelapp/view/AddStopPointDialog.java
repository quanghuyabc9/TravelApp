    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        submitBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                StopPointInfo stopPointInfo = new StopPointInfo(spname, address, provinceId, latitude, longitude, millisArriveDate, millisLeaveDate, serviceTypeId, minCost, maxCost);
