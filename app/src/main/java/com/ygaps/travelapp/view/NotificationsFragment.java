...
public class NotificationsFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        final SearchView searchView = (SearchView) view.findViewById(R.id.tour_searchv_listInvite);
        ...
        String url="http://35.197.153.192:3000/tour/get/invitation?pageSize=200&pageIndex=1";
        ...
        JsonObjectRequest req = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    TextView tv= (TextView) view.findViewById(R.id.tour_num_listInvite);
...
//                             img = "@drawable/alternative_view";
                    ...
                    mRecyclerView = view.findViewById(R.id.rview_listInvite);
                    ...
                    final TextView notFound = view.findViewById(R.id.no_found_tour_location_listInvite);
